...
<template>
  ...
  <div class="flex gap-4 mb-8">
    <div class="flex flex-col">
      ...
      <CustomButton variant="primary" size="sm"> button </CustomButton>
    </div>
    <div class="flex flex-col">
      <label htmlFor="">size md</label>
      <CustomButton variant="primary" size="md"> button </CustomButton>
    </div>
    <div class="flex flex-col">
      <label htmlFor="">size lg</label>
      <CustomButton variant="primary" size="lg"> button </CustomButton>
    </div>
  </div>
  ...
  <div class="flex gap-4 mb-8">
    <div class="flex flex-col">
      <label htmlFor="">size sm</label>
      <CustomButton variant="secondary" size="sm"> button </CustomButton>
    </div>
    <div class="flex flex-col">
      <label htmlFor="">size md</label>
      <CustomButton variant="secondary" size="md"> button </CustomButton>
    </div>
    <div class="flex flex-col">
      <label htmlFor="">size lg</label>
      <CustomButton variant="secondary" size="lg"> button </CustomButton>
    </div>
  </div>
  ...
  <div class="flex gap-4 mb-8">
    <div class="flex flex-col">
      <label htmlFor="">size sm</label>
      <CustomButton variant="outline" size="sm"> button </CustomButton>
    </div>
    <div class="flex flex-col">
      <label htmlFor="">size md</label>
      <CustomButton variant="outline" size="md"> button </CustomButton>
    </div>
    <div class="flex flex-col">
      <label htmlFor="">size lg</label>
      <CustomButton variant="outline" size="lg"> button </CustomButton>
    </div>
  </div>
